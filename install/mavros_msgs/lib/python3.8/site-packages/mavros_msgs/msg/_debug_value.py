...
class Metaclass_DebugValue(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'TYPE_DEBUG_ARRAY': cls.__constants['TYPE_DEBUG_ARRAY'],
    ...
    @property
    def TYPE_DEBUG_ARRAY(self):
        """Message constant 'TYPE_DEBUG_ARRAY'."""
        return Metaclass_DebugValue.__constants['TYPE_DEBUG_ARRAY']
