...
#ifndef ESCInfo_Plugin_150721969_h
#define ESCInfo_Plugin_150721969_h
...
namespace mavros_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define ESCInfo_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ESCInfo_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ESCInfo_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ESCInfo_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ESCInfo_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ESCInfo_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ESCInfo_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ESCInfo_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ESCInfo_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ESCInfo_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ESCInfo_Plugin_new(void);

            NDDSUSERDllExport extern void
            ESCInfo_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ESCInfo_Plugin_150721969_h */
