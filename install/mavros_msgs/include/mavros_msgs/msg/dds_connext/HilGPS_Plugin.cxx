        ...
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
                ...
                const struct DDS_TypeAllocationParams_t * alloc_params) 
            {
                ...
                sample = new (std::nothrow) HilGPS_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!mavros_msgs::msg::dds_::HilGPS__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            HilGPS_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!mavros_msgs::msg::dds_::HilGPS__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return mavros_msgs::msg::dds_::HilGPS_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            HilGPS_PluginSupport_destroy_data_w_params(
                ...
                mavros_msgs::msg::dds_::HilGPS__finalize_w_params(sample,dealloc_params);
            ...
            HilGPS_PluginSupport_destroy_data_ex(
                ...
                mavros_msgs::msg::dds_::HilGPS__finalize_ex(sample,deallocate_pointers);
            ...
            HilGPS_PluginSupport_destroy_data(
                ...
                mavros_msgs::msg::dds_::HilGPS_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            HilGPS_PluginSupport_copy_data(
                ...
                const HilGPS_ *src)
            {
                return mavros_msgs::msg::dds_::HilGPS__copy(dst,(const HilGPS_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    mavros_msgs::msg::dds_::HilGPS_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    mavros_msgs::msg::dds_::HilGPS_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = mavros_msgs::msg::dds_::HilGPS_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        mavros_msgs::msg::dds_::HilGPS_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        mavros_msgs::msg::dds_::HilGPS_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                HilGPS__finalize_optional_members(sample, RTI_TRUE);
                ...
                const HilGPS_ *src)
            {
                ...
                return mavros_msgs::msg::dds_::HilGPS_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        mavros_msgs::msg::dds_::HilGPS__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const HilGPS_ *sample)
            {
                ...
                result = mavros_msgs::msg::dds_::HilGPS_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                HilGPS__finalize_optional_members(sample, RTI_TRUE);
                return HilGPS_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!HilGPS_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "HilGPS_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= mavros_msgs::msg::dds_::HilGPS_Plugin_deserialize_sample( 
                ...
                unsigned int current_alignment)
            {
                ...
                size = HilGPS_Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!mavros_msgs::msg::dds_::HilGPS_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
            ...
            RTIBool HilGPS_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                HilGPS_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!mavros_msgs::msg::dds_::HilGPS_Plugin_deserialize_sample(
            ...
            RTIBool HilGPS_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                HilGPS_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= mavros_msgs::msg::dds_::HilGPS_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += mavros_msgs::msg::dds_::HilGPS_Plugin_get_serialized_sample_max_size_ex(
                    endpoint_data, overflow,RTI_FALSE, encapsulation_id, current_alignment);
                ...
                unsigned int current_alignment)
            {
                ...
                size = HilGPS_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *HilGPS_Plugin_new(void) 
            { 
                ...
                mavros_msgs::msg::dds_::HilGPS_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                mavros_msgs::msg::dds_::HilGPS_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                mavros_msgs::msg::dds_::HilGPS_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                mavros_msgs::msg::dds_::HilGPS_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                mavros_msgs::msg::dds_::HilGPS_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                HilGPS_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                HilGPS_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                HilGPS__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                mavros_msgs::msg::dds_::HilGPS_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                mavros_msgs::msg::dds_::HilGPS_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                mavros_msgs::msg::dds_::HilGPS_Plugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                mavros_msgs::msg::dds_::HilGPS_Plugin_get_serialized_sample_min_size;

                plugin->getSampleFnc =
                (PRESTypePluginGetSampleFunction)
                HilGPS_Plugin_get_sample;
                ...
                mavros_msgs::msg::dds_::HilGPS_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)mavros_msgs::msg::dds_::HilGPS__get_typecode();
                ...
                HilGPS_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                HilGPS_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                mavros_msgs::msg::dds_::HilGPS_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = HilGPS_TYPENAME;

                return plugin;
            }

            void
            HilGPS_Plugin_delete(struct PRESTypePlugin *plugin)
            {
