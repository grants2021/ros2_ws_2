        ...
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
                ...
                const struct DDS_TypeAllocationParams_t * alloc_params) 
            {
                ...
                if (!mavros_msgs::msg::dds_::Waypoint__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            Waypoint_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!mavros_msgs::msg::dds_::Waypoint__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return mavros_msgs::msg::dds_::Waypoint_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            Waypoint_PluginSupport_destroy_data_w_params(
                ...
                mavros_msgs::msg::dds_::Waypoint__finalize_w_params(sample,dealloc_params);
            ...
            Waypoint_PluginSupport_destroy_data_ex(
                ...
                mavros_msgs::msg::dds_::Waypoint__finalize_ex(sample,deallocate_pointers);
            ...
            Waypoint_PluginSupport_destroy_data(
                ...
                mavros_msgs::msg::dds_::Waypoint_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            Waypoint_PluginSupport_copy_data(
                ...
                const Waypoint_ *src)
            {
                return mavros_msgs::msg::dds_::Waypoint__copy(dst,(const Waypoint_*) src);
            }
                ...
                unsigned int indent_level)
            {
                ...
                RTICdrType_printBoolean(
                    &sample->is_current_, "is_current_", indent_level + 1);    
                ...
                RTICdrType_printDouble(
                    &sample->x_lat_, "x_lat_", indent_level + 1);    

                RTICdrType_printDouble(
                    &sample->y_long_, "y_long_", indent_level + 1);    

                RTICdrType_printDouble(
                    &sample->z_alt_, "z_alt_", indent_level + 1);    
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    mavros_msgs::msg::dds_::Waypoint_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    mavros_msgs::msg::dds_::Waypoint_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = mavros_msgs::msg::dds_::Waypoint_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        mavros_msgs::msg::dds_::Waypoint_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        mavros_msgs::msg::dds_::Waypoint_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                const Waypoint_ *src)
            {
                ...
                return mavros_msgs::msg::dds_::Waypoint_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_sample) {
                    ...
                    if (!RTICdrStream_serializeDouble(
                        stream, &sample->x_lat_)) {
                        return RTI_FALSE;
                    }

                    if (!RTICdrStream_serializeDouble(
                        stream, &sample->y_long_)) {
                        return RTI_FALSE;
                    }

                    if (!RTICdrStream_serializeDouble(
                        stream, &sample->z_alt_)) {
                        return RTI_FALSE;
                    }
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        mavros_msgs::msg::dds_::Waypoint__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const Waypoint_ *sample)
            {
                ...
                result = mavros_msgs::msg::dds_::Waypoint_Plugin_serialize(
                ...
                void *endpoint_plugin_qos)
            {
                ...
                result= mavros_msgs::msg::dds_::Waypoint_Plugin_deserialize_sample( 
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!mavros_msgs::msg::dds_::Waypoint_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!mavros_msgs::msg::dds_::Waypoint_Plugin_deserialize_sample(
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= mavros_msgs::msg::dds_::Waypoint_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += mavros_msgs::msg::dds_::Waypoint_Plugin_get_serialized_sample_max_size_ex(
            ...
            * ------------------------------------------------------------------------ */
            ...
            { 
                ...
                mavros_msgs::msg::dds_::Waypoint_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                mavros_msgs::msg::dds_::Waypoint_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                mavros_msgs::msg::dds_::Waypoint_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                mavros_msgs::msg::dds_::Waypoint_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                mavros_msgs::msg::dds_::Waypoint_Plugin_copy_sample;
                ...
                mavros_msgs::msg::dds_::Waypoint_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                mavros_msgs::msg::dds_::Waypoint_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                mavros_msgs::msg::dds_::Waypoint_Plugin_get_serialized_sample_max_size;
                ...
                mavros_msgs::msg::dds_::Waypoint_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)mavros_msgs::msg::dds_::Waypoint__get_typecode();
