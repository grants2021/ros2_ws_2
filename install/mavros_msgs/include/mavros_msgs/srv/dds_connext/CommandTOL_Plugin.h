...
#ifndef CommandTOL_Plugin_2065259686_h
#define CommandTOL_Plugin_2065259686_h
...
namespace mavros_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define CommandTOL_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define CommandTOL_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define CommandTOL_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define CommandTOL_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define CommandTOL_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern CommandTOL_Request_*
            ...
            CommandTOL_Request_PluginSupport_copy_data(
                CommandTOL_Request_ *out,
                const CommandTOL_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            CommandTOL_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            CommandTOL_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                CommandTOL_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            CommandTOL_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CommandTOL_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            CommandTOL_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            CommandTOL_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace mavros_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define CommandTOL_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define CommandTOL_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define CommandTOL_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define CommandTOL_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define CommandTOL_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern CommandTOL_Response_*
            ...
            CommandTOL_Response_PluginSupport_copy_data(
                CommandTOL_Response_ *out,
                const CommandTOL_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            CommandTOL_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            CommandTOL_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                CommandTOL_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            CommandTOL_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                CommandTOL_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            CommandTOL_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            CommandTOL_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* CommandTOL_Plugin_2065259686_h */
