...
class Contact(metaclass=Metaclass_Contact):
    ...
    def __init__(self, **kwargs):
        ...
        self.collision1 = kwargs.get('collision1', str())
        self.collision2 = kwargs.get('collision2', str())
    ...
    def collision1(self, value):
        if __debug__:
            assert \
                ...
                "The 'collision1' field must be of type 'str'"
    ...
    def collision2(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'collision2' field must be of type 'str'"
