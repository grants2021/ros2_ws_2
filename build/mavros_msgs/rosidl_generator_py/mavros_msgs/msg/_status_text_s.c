...
bool mavros_msgs__msg__status_text__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._status_text.StatusText", full_classname_dest, 39) == 0);
  }
  mavros_msgs__msg__StatusText * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of StatusText */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._status_text");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StatusText");
