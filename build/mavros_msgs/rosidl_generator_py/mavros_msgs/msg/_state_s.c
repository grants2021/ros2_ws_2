...
bool mavros_msgs__msg__state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._state.State", full_classname_dest, 28) == 0);
  }
  mavros_msgs__msg__State * ros_message = _ros_message;
  {  // header
  ...
  {  // guided
    PyObject * field = PyObject_GetAttrString(_pymsg, "guided");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->guided = (Py_True == field);
    Py_DECREF(field);
  }
  {  // manual_input
    PyObject * field = PyObject_GetAttrString(_pymsg, "manual_input");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->manual_input = (Py_True == field);
    Py_DECREF(field);
  }
  {  // mode
...
PyObject * mavros_msgs__msg__state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._state");
  ...
  {  // guided
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->guided ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "guided", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // manual_input
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->manual_input ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "manual_input", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
