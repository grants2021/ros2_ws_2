...
static const _CommandTriggerInterval_Request_type_support_symbol_names_t _CommandTriggerInterval_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, mavros_msgs, srv, CommandTriggerInterval_Request)),
...
static const _CommandTriggerInterval_Response_type_support_symbol_names_t _CommandTriggerInterval_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, mavros_msgs, srv, CommandTriggerInterval_Response)),
...
static const _CommandTriggerInterval_type_support_symbol_names_t _CommandTriggerInterval_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, mavros_msgs, srv, CommandTriggerInterval)),
