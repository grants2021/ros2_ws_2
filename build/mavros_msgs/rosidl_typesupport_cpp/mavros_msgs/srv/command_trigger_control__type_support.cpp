...
static const _CommandTriggerControl_Request_type_support_symbol_names_t _CommandTriggerControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, mavros_msgs, srv, CommandTriggerControl_Request)),
...
static const _CommandTriggerControl_Response_type_support_symbol_names_t _CommandTriggerControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, mavros_msgs, srv, CommandTriggerControl_Response)),
...
static const _CommandTriggerControl_type_support_symbol_names_t _CommandTriggerControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, mavros_msgs, srv, CommandTriggerControl)),
