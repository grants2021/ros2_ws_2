...
DDS_TypeCode *
get_type_code__MountConfigure_Request()
{
  ...
  mavros_msgs::srv::dds_::MountConfigure_Request_ & dds_message)
{
  ...
  dds_message.stabilize_roll_ =
    ros_message.stabilize_roll;

  // member.name stabilize_pitch
  dds_message.stabilize_pitch_ =
    ros_message.stabilize_pitch;

  // member.name stabilize_yaw
  dds_message.stabilize_yaw_ =
    ros_message.stabilize_yaw;

  // member.name roll_input
  dds_message.roll_input_ =
    ros_message.roll_input;

  // member.name pitch_input
  dds_message.pitch_input_ =
    ros_message.pitch_input;

  // member.name yaw_input
  dds_message.yaw_input_ =
    ros_message.yaw_input;
  ...
  mavros_msgs::srv::MountConfigure_Request & ros_message)
{
  ...
  // member.name stabilize_roll
  ros_message.stabilize_roll =
    dds_message.stabilize_roll_ == DDS_BOOLEAN_TRUE;

  // member.name stabilize_pitch
  ros_message.stabilize_pitch =
    dds_message.stabilize_pitch_ == DDS_BOOLEAN_TRUE;

  // member.name stabilize_yaw
  ros_message.stabilize_yaw =
    dds_message.stabilize_yaw_ == DDS_BOOLEAN_TRUE;
...
bool
to_cdr_stream__MountConfigure_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::MountConfigure_Request & ros_message =
    *(const mavros_msgs::srv::MountConfigure_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::MountConfigure_Request_ * dds_message = mavros_msgs::srv::dds_::MountConfigure_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__MountConfigure_Request(
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::MountConfigure_Request & ros_message =
    *(mavros_msgs::srv::MountConfigure_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_MountConfigure_Request__handle;
}
...
DDS_TypeCode *
get_type_code__MountConfigure_Response()
{
...
bool
to_cdr_stream__MountConfigure_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::MountConfigure_Response & ros_message =
    *(const mavros_msgs::srv::MountConfigure_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::MountConfigure_Response_ * dds_message = mavros_msgs::srv::dds_::MountConfigure_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__MountConfigure_Response(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  mavros_msgs::srv::MountConfigure_Response & ros_message =
    *(mavros_msgs::srv::MountConfigure_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::MountConfigure_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_MountConfigure_Response__handle;
}
...
void * create_requester__MountConfigure(
...
const char * destroy_requester__MountConfigure(
...
int64_t send_request__MountConfigure(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::MountConfigure_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::MountConfigure_Request_,
    mavros_msgs::srv::dds_::MountConfigure_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::MountConfigure_Request_> request;
...
void * create_replier__MountConfigure(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__MountConfigure(
...
bool take_request__MountConfigure(
  void * untyped_replier,
...
bool take_response__MountConfigure(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::MountConfigure_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::MountConfigure_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::MountConfigure_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::MountConfigure_Request_,
    mavros_msgs::srv::dds_::MountConfigure_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_MountConfigure__handle;
}
