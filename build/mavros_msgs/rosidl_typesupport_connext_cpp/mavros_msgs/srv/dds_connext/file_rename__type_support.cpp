...
DDS_TypeCode *
get_type_code__FileRename_Request()
{
  ...
  mavros_msgs::srv::dds_::FileRename_Request_ & dds_message)
{
  ...
  DDS_String_free(dds_message.old_path_);
  dds_message.old_path_ =
    DDS_String_dup(ros_message.old_path.c_str());

  // member.name new_path
  DDS_String_free(dds_message.new_path_);
  dds_message.new_path_ =
    DDS_String_dup(ros_message.new_path.c_str());
...
{
  // member.name old_path
  ros_message.old_path = dds_message.old_path_;

  // member.name new_path
  ros_message.new_path = dds_message.new_path_;

  return true;
}

bool
to_cdr_stream__FileRename_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::FileRename_Request & ros_message =
    *(const mavros_msgs::srv::FileRename_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::FileRename_Request_ * dds_message = mavros_msgs::srv::dds_::FileRename_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__FileRename_Request(
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::FileRename_Request & ros_message =
    *(mavros_msgs::srv::FileRename_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_FileRename_Request__handle;
}
...
DDS_TypeCode *
get_type_code__FileRename_Response()
{
...
bool
to_cdr_stream__FileRename_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::FileRename_Response & ros_message =
    *(const mavros_msgs::srv::FileRename_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::FileRename_Response_ * dds_message = mavros_msgs::srv::dds_::FileRename_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__FileRename_Response(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  mavros_msgs::srv::FileRename_Response & ros_message =
    *(mavros_msgs::srv::FileRename_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::FileRename_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_FileRename_Response__handle;
}
...
void * create_requester__FileRename(
...
const char * destroy_requester__FileRename(
...
int64_t send_request__FileRename(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::FileRename_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::FileRename_Request_,
    mavros_msgs::srv::dds_::FileRename_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::FileRename_Request_> request;
...
void * create_replier__FileRename(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__FileRename(
...
bool take_response__FileRename(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::FileRename_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::FileRename_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::FileRename_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::FileRename_Request_,
    mavros_msgs::srv::dds_::FileRename_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_FileRename__handle;
}
