...
DDS_TypeCode *
get_type_code__ParamSetV2_Request()
{
  ...
  mavros_msgs::srv::dds_::ParamSetV2_Request_ & dds_message)
{
  ...
  dds_message.force_set_ =
    ros_message.force_set;
  ...
  // member.name value
  if (
    !rcl_interfaces::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
      ros_message.value,
      dds_message.value_))
  {
    return false;
  ...
  mavros_msgs::srv::ParamSetV2_Request & ros_message)
{
  // member.name force_set
  ros_message.force_set =
    dds_message.force_set_ == DDS_BOOLEAN_TRUE;
  ...
  // member.name value
  if (
    !rcl_interfaces::msg::typesupport_connext_cpp::convert_dds_message_to_ros(
      dds_message.value_,
      ros_message.value))
  {
    return false;
...
bool
to_cdr_stream__ParamSetV2_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::ParamSetV2_Request & ros_message =
    *(const mavros_msgs::srv::ParamSetV2_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::ParamSetV2_Request_ * dds_message = mavros_msgs::srv::dds_::ParamSetV2_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__ParamSetV2_Request(
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::ParamSetV2_Request & ros_message =
    *(mavros_msgs::srv::ParamSetV2_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_ParamSetV2_Request__handle;
}
...
DDS_TypeCode *
get_type_code__ParamSetV2_Response()
{
...
bool
to_cdr_stream__ParamSetV2_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::ParamSetV2_Response & ros_message =
    *(const mavros_msgs::srv::ParamSetV2_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::ParamSetV2_Response_ * dds_message = mavros_msgs::srv::dds_::ParamSetV2_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__ParamSetV2_Response(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  mavros_msgs::srv::ParamSetV2_Response & ros_message =
    *(mavros_msgs::srv::ParamSetV2_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::ParamSetV2_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_ParamSetV2_Response__handle;
}
...
void * create_requester__ParamSetV2(
...
const char * destroy_requester__ParamSetV2(
...
int64_t send_request__ParamSetV2(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::ParamSetV2_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::ParamSetV2_Request_,
    mavros_msgs::srv::dds_::ParamSetV2_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::ParamSetV2_Request_> request;
...
void * create_replier__ParamSetV2(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__ParamSetV2(
...
bool take_response__ParamSetV2(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::ParamSetV2_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::ParamSetV2_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::ParamSetV2_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::ParamSetV2_Request_,
    mavros_msgs::srv::dds_::ParamSetV2_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_ParamSetV2__handle;
}
