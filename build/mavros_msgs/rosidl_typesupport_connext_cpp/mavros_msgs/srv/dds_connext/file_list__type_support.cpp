...
DDS_TypeCode *
get_type_code__FileList_Request()
{
...
bool
to_cdr_stream__FileList_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::FileList_Request & ros_message =
    *(const mavros_msgs::srv::FileList_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::FileList_Request_ * dds_message = mavros_msgs::srv::dds_::FileList_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::FileList_Request & ros_message =
    *(mavros_msgs::srv::FileList_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_FileList_Request__handle;
}
...
bool convert_ros_message_to_dds(
  ...
  mavros_msgs::msg::dds_::FileEntry_ &);
bool convert_dds_message_to_ros(
  const mavros_msgs::msg::dds_::FileEntry_ &,
...
DDS_TypeCode *
get_type_code__FileList_Response()
{
    ...
    for (size_t i = 0; i < size; i++) {
      if (
        !mavros_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
          ros_message.list[i],
          dds_message.list_[static_cast<DDS_Long>(i)]))
      {
        return false;
      }
    }
  ...
  mavros_msgs::srv::FileList_Response & ros_message)
{
  // member.name list
  {
    size_t size = dds_message.list_.length();
...
bool
to_cdr_stream__FileList_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::FileList_Response & ros_message =
    *(const mavros_msgs::srv::FileList_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::FileList_Response_ * dds_message = mavros_msgs::srv::dds_::FileList_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::FileList_Response & ros_message =
    *(mavros_msgs::srv::FileList_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::FileList_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_FileList_Response__handle;
}
...
void * create_requester__FileList(
...
const char * destroy_requester__FileList(
...
int64_t send_request__FileList(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::FileList_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::FileList_Request_,
    mavros_msgs::srv::dds_::FileList_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::FileList_Request_> request;
...
const char * destroy_replier__FileList(
  ...
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::FileList_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::FileList_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::FileList_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::FileList_Request_,
    mavros_msgs::srv::dds_::FileList_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_FileList__handle;
}
