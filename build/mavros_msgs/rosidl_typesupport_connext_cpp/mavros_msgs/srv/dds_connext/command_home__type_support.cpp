...
DDS_TypeCode *
get_type_code__CommandHome_Request()
{
  ...
  mavros_msgs::srv::dds_::CommandHome_Request_ & dds_message)
{
  ...
  dds_message.current_gps_ =
    ros_message.current_gps;
  ...
  mavros_msgs::srv::CommandHome_Request & ros_message)
{
  // member.name current_gps
  ros_message.current_gps =
    dds_message.current_gps_ == DDS_BOOLEAN_TRUE;
...
bool
to_cdr_stream__CommandHome_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::CommandHome_Request & ros_message =
    *(const mavros_msgs::srv::CommandHome_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::CommandHome_Request_ * dds_message = mavros_msgs::srv::dds_::CommandHome_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__CommandHome_Request(
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::CommandHome_Request & ros_message =
    *(mavros_msgs::srv::CommandHome_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_CommandHome_Request__handle;
}
...
DDS_TypeCode *
get_type_code__CommandHome_Response()
{
...
bool
to_cdr_stream__CommandHome_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::CommandHome_Response & ros_message =
    *(const mavros_msgs::srv::CommandHome_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::CommandHome_Response_ * dds_message = mavros_msgs::srv::dds_::CommandHome_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__CommandHome_Response(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  mavros_msgs::srv::CommandHome_Response & ros_message =
    *(mavros_msgs::srv::CommandHome_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::CommandHome_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_CommandHome_Response__handle;
}
...
void * create_requester__CommandHome(
...
const char * destroy_requester__CommandHome(
...
int64_t send_request__CommandHome(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::CommandHome_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::CommandHome_Request_,
    mavros_msgs::srv::dds_::CommandHome_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::CommandHome_Request_> request;
...
void * create_replier__CommandHome(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__CommandHome(
...
bool take_request__CommandHome(
  void * untyped_replier,
...
bool take_response__CommandHome(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::CommandHome_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::CommandHome_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::CommandHome_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::CommandHome_Request_,
    mavros_msgs::srv::dds_::CommandHome_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_CommandHome__handle;
}
