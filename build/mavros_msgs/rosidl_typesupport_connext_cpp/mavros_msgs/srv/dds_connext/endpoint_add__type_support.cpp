...
DDS_TypeCode *
get_type_code__EndpointAdd_Request()
{
...
{
  // member.name url
  DDS_String_free(dds_message.url_);
  dds_message.url_ =
    DDS_String_dup(ros_message.url.c_str());
...
{
  // member.name url
  ros_message.url = dds_message.url_;
...
bool
to_cdr_stream__EndpointAdd_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::EndpointAdd_Request & ros_message =
    *(const mavros_msgs::srv::EndpointAdd_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::EndpointAdd_Request_ * dds_message = mavros_msgs::srv::dds_::EndpointAdd_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__EndpointAdd_Request(
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::EndpointAdd_Request & ros_message =
    *(mavros_msgs::srv::EndpointAdd_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_EndpointAdd_Request__handle;
}
...
DDS_TypeCode *
get_type_code__EndpointAdd_Response()
{
  ...
  mavros_msgs::srv::dds_::EndpointAdd_Response_ & dds_message)
{
  ...
  dds_message.successful_ =
    ros_message.successful;

  // member.name reason
  DDS_String_free(dds_message.reason_);
  dds_message.reason_ =
    DDS_String_dup(ros_message.reason.c_str());
  ...
  mavros_msgs::srv::EndpointAdd_Response & ros_message)
{
  // member.name successful
  ros_message.successful =
    dds_message.successful_ == DDS_BOOLEAN_TRUE;

  // member.name reason
  ros_message.reason = dds_message.reason_;
...
bool
to_cdr_stream__EndpointAdd_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::EndpointAdd_Response & ros_message =
    *(const mavros_msgs::srv::EndpointAdd_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::EndpointAdd_Response_ * dds_message = mavros_msgs::srv::dds_::EndpointAdd_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__EndpointAdd_Response(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  mavros_msgs::srv::EndpointAdd_Response & ros_message =
    *(mavros_msgs::srv::EndpointAdd_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::EndpointAdd_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_EndpointAdd_Response__handle;
}
...
void * create_requester__EndpointAdd(
...
const char * destroy_requester__EndpointAdd(
...
int64_t send_request__EndpointAdd(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::EndpointAdd_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::EndpointAdd_Request_,
    mavros_msgs::srv::dds_::EndpointAdd_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::EndpointAdd_Request_> request;
...
void * create_replier__EndpointAdd(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__EndpointAdd(
...
bool take_request__EndpointAdd(
  void * untyped_replier,
...
bool take_response__EndpointAdd(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::EndpointAdd_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::EndpointAdd_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::EndpointAdd_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::EndpointAdd_Request_,
    mavros_msgs::srv::dds_::EndpointAdd_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_EndpointAdd__handle;
}
