...
#ifndef WaypointClear_Plugin_532922421_h
#define WaypointClear_Plugin_532922421_h
...
namespace mavros_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define WaypointClear_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define WaypointClear_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define WaypointClear_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define WaypointClear_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define WaypointClear_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern WaypointClear_Request_*
            ...
            WaypointClear_Request_PluginSupport_copy_data(
                WaypointClear_Request_ *out,
                const WaypointClear_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            WaypointClear_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            WaypointClear_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                WaypointClear_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            WaypointClear_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                WaypointClear_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            WaypointClear_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            WaypointClear_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace mavros_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define WaypointClear_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define WaypointClear_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define WaypointClear_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define WaypointClear_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define WaypointClear_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern WaypointClear_Response_*
            ...
            WaypointClear_Response_PluginSupport_copy_data(
                WaypointClear_Response_ *out,
                const WaypointClear_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            WaypointClear_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            WaypointClear_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                WaypointClear_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            WaypointClear_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                WaypointClear_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            WaypointClear_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            WaypointClear_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* WaypointClear_Plugin_532922421_h */
