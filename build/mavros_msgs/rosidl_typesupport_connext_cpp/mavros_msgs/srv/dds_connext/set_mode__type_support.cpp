...
DDS_TypeCode *
get_type_code__SetMode_Request()
{
  ...
  mavros_msgs::srv::dds_::SetMode_Request_ & dds_message)
{
  ...
  DDS_String_free(dds_message.custom_mode_);
  dds_message.custom_mode_ =
    DDS_String_dup(ros_message.custom_mode.c_str());
...
bool
to_cdr_stream__SetMode_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::SetMode_Request & ros_message =
    *(const mavros_msgs::srv::SetMode_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::SetMode_Request_ * dds_message = mavros_msgs::srv::dds_::SetMode_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::SetMode_Request & ros_message =
    *(mavros_msgs::srv::SetMode_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_SetMode_Request__handle;
}
...
DDS_TypeCode *
get_type_code__SetMode_Response()
{
  ...
  mavros_msgs::srv::dds_::SetMode_Response_ & dds_message)
{
  ...
  dds_message.mode_sent_ =
    ros_message.mode_sent;
  ...
  mavros_msgs::srv::SetMode_Response & ros_message)
{
  // member.name mode_sent
  ros_message.mode_sent =
    dds_message.mode_sent_ == DDS_BOOLEAN_TRUE;

  return true;
}

bool
to_cdr_stream__SetMode_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::SetMode_Response & ros_message =
    *(const mavros_msgs::srv::SetMode_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::SetMode_Response_ * dds_message = mavros_msgs::srv::dds_::SetMode_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::SetMode_Response & ros_message =
    *(mavros_msgs::srv::SetMode_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::SetMode_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_SetMode_Response__handle;
}
...
void * create_requester__SetMode(
...
const char * destroy_requester__SetMode(
...
int64_t send_request__SetMode(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::SetMode_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::SetMode_Request_,
    mavros_msgs::srv::dds_::SetMode_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::SetMode_Request_> request;
...
const char * destroy_replier__SetMode(
  ...
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::SetMode_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::SetMode_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::SetMode_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::SetMode_Request_,
    mavros_msgs::srv::dds_::SetMode_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_SetMode__handle;
}
