...
DDS_TypeCode *
get_type_code__VehicleInfoGet_Request()
{
  ...
  mavros_msgs::srv::VehicleInfoGet_Request & ros_message)
{
  ...
  // member.name get_all
  ros_message.get_all =
    dds_message.get_all_ == DDS_BOOLEAN_TRUE;

  return true;
}

bool
to_cdr_stream__VehicleInfoGet_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::VehicleInfoGet_Request & ros_message =
    *(const mavros_msgs::srv::VehicleInfoGet_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::VehicleInfoGet_Request_ * dds_message = mavros_msgs::srv::dds_::VehicleInfoGet_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__VehicleInfoGet_Request(
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::VehicleInfoGet_Request & ros_message =
    *(mavros_msgs::srv::VehicleInfoGet_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_VehicleInfoGet_Request__handle;
}
...
bool convert_ros_message_to_dds(
  ...
  mavros_msgs::msg::dds_::VehicleInfo_ &);
bool convert_dds_message_to_ros(
  const mavros_msgs::msg::dds_::VehicleInfo_ &,
...
DDS_TypeCode *
get_type_code__VehicleInfoGet_Response()
{
    ...
    for (size_t i = 0; i < size; i++) {
      if (
        !mavros_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
          ...
          dds_message.vehicles_[static_cast<DDS_Long>(i)]))
      {
        return false;
      }
    }
  ...
  mavros_msgs::srv::VehicleInfoGet_Response & ros_message)
{
  ...
  // member.name vehicles
  {
    size_t size = dds_message.vehicles_.length();
...
bool
to_cdr_stream__VehicleInfoGet_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::VehicleInfoGet_Response & ros_message =
    *(const mavros_msgs::srv::VehicleInfoGet_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::VehicleInfoGet_Response_ * dds_message = mavros_msgs::srv::dds_::VehicleInfoGet_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__VehicleInfoGet_Response(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  mavros_msgs::srv::VehicleInfoGet_Response & ros_message =
    *(mavros_msgs::srv::VehicleInfoGet_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::VehicleInfoGet_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_VehicleInfoGet_Response__handle;
}
...
void * create_requester__VehicleInfoGet(
...
const char * destroy_requester__VehicleInfoGet(
...
int64_t send_request__VehicleInfoGet(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::VehicleInfoGet_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::VehicleInfoGet_Request_,
    mavros_msgs::srv::dds_::VehicleInfoGet_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::VehicleInfoGet_Request_> request;
...
void * create_replier__VehicleInfoGet(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__VehicleInfoGet(
...
bool take_request__VehicleInfoGet(
  void * untyped_replier,
...
bool take_response__VehicleInfoGet(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::VehicleInfoGet_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::VehicleInfoGet_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::VehicleInfoGet_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::VehicleInfoGet_Request_,
    mavros_msgs::srv::dds_::VehicleInfoGet_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_VehicleInfoGet__handle;
}
