...
bool convert_ros_message_to_dds(
  ...
  mavros_msgs::msg::dds_::Waypoint_ &);
bool convert_dds_message_to_ros(
  const mavros_msgs::msg::dds_::Waypoint_ &,
...
DDS_TypeCode *
get_type_code__WaypointPush_Request()
{
  ...
  mavros_msgs::srv::dds_::WaypointPush_Request_ & dds_message)
{
  ...
  dds_message.start_index_ =
    ros_message.start_index;
    ...
    for (size_t i = 0; i < size; i++) {
      if (
        !mavros_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
          ...
          dds_message.waypoints_[static_cast<DDS_Long>(i)]))
      {
        return false;
      }
    }
  ...
  mavros_msgs::srv::WaypointPush_Request & ros_message)
{
  ...
  // member.name waypoints
  {
    size_t size = dds_message.waypoints_.length();
...
bool
to_cdr_stream__WaypointPush_Request(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::srv::WaypointPush_Request & ros_message =
    *(const mavros_msgs::srv::WaypointPush_Request *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::WaypointPush_Request_ * dds_message = mavros_msgs::srv::dds_::WaypointPush_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__WaypointPush_Request(
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::srv::WaypointPush_Request & ros_message =
    *(mavros_msgs::srv::WaypointPush_Request *)untyped_ros_message;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_WaypointPush_Request__handle;
}
...
DDS_TypeCode *
get_type_code__WaypointPush_Response()
{
  ...
  mavros_msgs::srv::dds_::WaypointPush_Response_ & dds_message)
{
  ...
  dds_message.wp_transfered_ =
    ros_message.wp_transfered;
...
bool
to_cdr_stream__WaypointPush_Response(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!cdr_stream) {
  ...
  // cast the untyped to the known ros message
  const mavros_msgs::srv::WaypointPush_Response & ros_message =
    *(const mavros_msgs::srv::WaypointPush_Response *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::srv::dds_::WaypointPush_Response_ * dds_message = mavros_msgs::srv::dds_::WaypointPush_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__WaypointPush_Response(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  mavros_msgs::srv::WaypointPush_Response & ros_message =
    *(mavros_msgs::srv::WaypointPush_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (mavros_msgs::srv::dds_::WaypointPush_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_WaypointPush_Response__handle;
}
...
void * create_requester__WaypointPush(
...
const char * destroy_requester__WaypointPush(
...
int64_t send_request__WaypointPush(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = mavros_msgs::srv::WaypointPush_Request;
  using RequesterType = connext::Requester<
    mavros_msgs::srv::dds_::WaypointPush_Request_,
    mavros_msgs::srv::dds_::WaypointPush_Response_
  >;
  connext::WriteSample<
    mavros_msgs::srv::dds_::WaypointPush_Request_> request;
...
void * create_replier__WaypointPush(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__WaypointPush(
...
bool take_request__WaypointPush(
  void * untyped_replier,
...
bool take_response__WaypointPush(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    mavros_msgs::srv::dds_::WaypointPush_Response_
  >;
  using ROSResponseType = mavros_msgs::srv::WaypointPush_Response;
...
{
  using ROSResponseType = const mavros_msgs::srv::WaypointPush_Response;
  using ReplierType = connext::Replier<
    mavros_msgs::srv::dds_::WaypointPush_Request_,
    mavros_msgs::srv::dds_::WaypointPush_Response_
  >;
...
{
  return &mavros_msgs::srv::typesupport_connext_cpp::_WaypointPush__handle;
}
