...
#include "mavros_msgs/msg/param_value__rosidl_typesupport_connext_cpp.hpp"
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::ParamValue & ros_message =
    *(const mavros_msgs::msg::ParamValue *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::ParamValue_ * dds_message = mavros_msgs::msg::dds_::ParamValue_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::ParamValue & ros_message =
    *(mavros_msgs::msg::ParamValue *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_ParamValue__handle;
}
