...
#include "mavros_msgs/msg/terrain_report__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::TerrainReport_ & dds_message)
{
  ...
  // member.name spacing
  dds_message.spacing_ =
    ros_message.spacing;

  // member.name terrain_height
  dds_message.terrain_height_ =
    ros_message.terrain_height;

  // member.name current_height
  dds_message.current_height_ =
    ros_message.current_height;

  // member.name pending
  dds_message.pending_ =
    ros_message.pending;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::TerrainReport & ros_message =
    *(const mavros_msgs::msg::TerrainReport *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::TerrainReport_ * dds_message = mavros_msgs::msg::dds_::TerrainReport_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::TerrainReport & ros_message =
    *(mavros_msgs::msg::TerrainReport *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_TerrainReport__handle;
}
