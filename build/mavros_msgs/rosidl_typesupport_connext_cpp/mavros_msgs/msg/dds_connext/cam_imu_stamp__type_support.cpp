...
#include "mavros_msgs/msg/cam_imu_stamp__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::CamIMUStamp_ & dds_message)
{
  ...
  if (
    !builtin_interfaces::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
      ...
      dds_message.frame_stamp_))
  {
    return false;
  }

  // member.name frame_seq_id
  dds_message.frame_seq_id_ =
    ros_message.frame_seq_id;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::CamIMUStamp & ros_message =
    *(const mavros_msgs::msg::CamIMUStamp *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::CamIMUStamp_ * dds_message = mavros_msgs::msg::dds_::CamIMUStamp_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::CamIMUStamp & ros_message =
    *(mavros_msgs::msg::CamIMUStamp *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_CamIMUStamp__handle;
}
