...
#include "mavros_msgs/msg/rc_out__rosidl_typesupport_connext_cpp.hpp"
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::RCOut & ros_message =
    *(const mavros_msgs::msg::RCOut *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::RCOut_ * dds_message = mavros_msgs::msg::dds_::RCOut_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::RCOut & ros_message =
    *(mavros_msgs::msg::RCOut *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_RCOut__handle;
}
