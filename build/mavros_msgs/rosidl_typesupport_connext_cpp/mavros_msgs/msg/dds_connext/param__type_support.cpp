...
#include "mavros_msgs/msg/param__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::Param_ & dds_message)
{
  ...
  dds_message.param_index_ =
    ros_message.param_index;

  // member.name param_count
  dds_message.param_count_ =
    ros_message.param_count;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::Param & ros_message =
    *(const mavros_msgs::msg::Param *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::Param_ * dds_message = mavros_msgs::msg::dds_::Param_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::Param & ros_message =
    *(mavros_msgs::msg::Param *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_Param__handle;
}
