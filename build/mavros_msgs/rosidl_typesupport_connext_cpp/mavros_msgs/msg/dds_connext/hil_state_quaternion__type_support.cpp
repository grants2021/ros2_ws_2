...
#include "mavros_msgs/msg/hil_state_quaternion__rosidl_typesupport_connext_cpp.hpp"
...
DDS_TypeCode *
get_type_code__HilStateQuaternion()
{
  ...
  mavros_msgs::msg::dds_::HilStateQuaternion_ & dds_message)
{
  ...
  if (
    !geometry_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
      ...
      dds_message.linear_acceleration_))
  {
    return false;
  }
  ...
  dds_message.ind_airspeed_ =
    ros_message.ind_airspeed;

  // member.name true_airspeed
  dds_message.true_airspeed_ =
...
bool
to_cdr_stream__HilStateQuaternion(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::HilStateQuaternion & ros_message =
    *(const mavros_msgs::msg::HilStateQuaternion *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::HilStateQuaternion_ * dds_message = mavros_msgs::msg::dds_::HilStateQuaternion_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
...
bool
to_message__HilStateQuaternion(
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::HilStateQuaternion & ros_message =
    *(mavros_msgs::msg::HilStateQuaternion *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_HilStateQuaternion__handle;
}
