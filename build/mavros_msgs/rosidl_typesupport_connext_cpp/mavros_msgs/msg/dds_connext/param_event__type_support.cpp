...
#include "mavros_msgs/msg/param_event__rosidl_typesupport_connext_cpp.hpp"
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::ParamEvent & ros_message =
    *(const mavros_msgs::msg::ParamEvent *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::ParamEvent_ * dds_message = mavros_msgs::msg::dds_::ParamEvent_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::ParamEvent & ros_message =
    *(mavros_msgs::msg::ParamEvent *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_ParamEvent__handle;
}
