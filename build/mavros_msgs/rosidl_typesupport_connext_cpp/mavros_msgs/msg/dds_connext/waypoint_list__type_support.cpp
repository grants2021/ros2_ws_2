...
#include "mavros_msgs/msg/waypoint_list__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::WaypointList_ & dds_message)
{
  ...
  dds_message.current_seq_ =
    ros_message.current_seq;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::WaypointList & ros_message =
    *(const mavros_msgs::msg::WaypointList *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::WaypointList_ * dds_message = mavros_msgs::msg::dds_::WaypointList_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::WaypointList & ros_message =
    *(mavros_msgs::msg::WaypointList *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_WaypointList__handle;
}
