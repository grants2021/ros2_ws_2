...
#include "mavros_msgs/msg/trajectory__rosidl_typesupport_connext_cpp.hpp"
...
bool convert_ros_message_to_dds(
  ...
  mavros_msgs::msg::dds_::PositionTarget_ &);
bool convert_dds_message_to_ros(
  const mavros_msgs::msg::dds_::PositionTarget_ &,
  ...
  mavros_msgs::msg::dds_::Trajectory_ & dds_message)
{
  ...
  // member.name point_valid
  {
    ...
    for (size_t i = 0; i < size; i++) {
      dds_message.point_valid_[static_cast<DDS_Long>(i)] =
        ros_message.point_valid[i];
    }
  }
  ...
  // member.name command
  {
    size_t size = 5;
    for (size_t i = 0; i < size; i++) {
      dds_message.command_[static_cast<DDS_Long>(i)] =
        ros_message.command[i];
    }
  }
  ...
  // member.name time_horizon
  {
    size_t size = 5;
    for (size_t i = 0; i < size; i++) {
      dds_message.time_horizon_[static_cast<DDS_Long>(i)] =
        ros_message.time_horizon[i];
    }
  }
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::Trajectory & ros_message =
    *(const mavros_msgs::msg::Trajectory *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::Trajectory_ * dds_message = mavros_msgs::msg::dds_::Trajectory_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::Trajectory & ros_message =
    *(mavros_msgs::msg::Trajectory *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_Trajectory__handle;
}
