...
#include "mavros_msgs/msg/rtcm__rosidl_typesupport_connext_cpp.hpp"
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::RTCM & ros_message =
    *(const mavros_msgs::msg::RTCM *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::RTCM_ * dds_message = mavros_msgs::msg::dds_::RTCM_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::RTCM & ros_message =
    *(mavros_msgs::msg::RTCM *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_RTCM__handle;
}
