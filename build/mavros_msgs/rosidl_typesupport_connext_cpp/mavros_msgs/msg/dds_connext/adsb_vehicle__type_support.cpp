...
#include "mavros_msgs/msg/adsb_vehicle__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::ADSBVehicle_ & dds_message)
{
  ...
  dds_message.icao_address_ =
    ros_message.icao_address;

  // member.name callsign
  DDS_String_free(dds_message.callsign_);
  dds_message.callsign_ =
    DDS_String_dup(ros_message.callsign.c_str());
  ...
  dds_message.hor_velocity_ =
    ros_message.hor_velocity;

  // member.name ver_velocity
  dds_message.ver_velocity_ =
    ros_message.ver_velocity;

  // member.name altitude_type
  dds_message.altitude_type_ =
    ros_message.altitude_type;

  // member.name emitter_type
  dds_message.emitter_type_ =
    ros_message.emitter_type;
  ...
  mavros_msgs::msg::ADSBVehicle & ros_message)
{
  ...
  // member.name callsign
  ros_message.callsign = dds_message.callsign_;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::ADSBVehicle & ros_message =
    *(const mavros_msgs::msg::ADSBVehicle *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::ADSBVehicle_ * dds_message = mavros_msgs::msg::dds_::ADSBVehicle_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::ADSBVehicle & ros_message =
    *(mavros_msgs::msg::ADSBVehicle *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_ADSBVehicle__handle;
}
