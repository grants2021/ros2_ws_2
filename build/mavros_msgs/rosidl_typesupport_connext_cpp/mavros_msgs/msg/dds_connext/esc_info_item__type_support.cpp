...
#include "mavros_msgs/msg/esc_info_item__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::ESCInfoItem_ & dds_message)
{
  ...
  dds_message.failure_flags_ =
    ros_message.failure_flags;

  // member.name error_count
  dds_message.error_count_ =
    ros_message.error_count;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::ESCInfoItem & ros_message =
    *(const mavros_msgs::msg::ESCInfoItem *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::ESCInfoItem_ * dds_message = mavros_msgs::msg::dds_::ESCInfoItem_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::ESCInfoItem & ros_message =
    *(mavros_msgs::msg::ESCInfoItem *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_ESCInfoItem__handle;
}
