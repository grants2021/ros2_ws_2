...
#include "mavros_msgs/msg/actuator_control__rosidl_typesupport_connext_cpp.hpp"
...
DDS_TypeCode *
get_type_code__ActuatorControl()
{
  ...
  mavros_msgs::msg::dds_::ActuatorControl_ & dds_message)
{
  ...
  dds_message.group_mix_ =
    ros_message.group_mix;
...
bool
to_cdr_stream__ActuatorControl(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::ActuatorControl & ros_message =
    *(const mavros_msgs::msg::ActuatorControl *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::ActuatorControl_ * dds_message = mavros_msgs::msg::dds_::ActuatorControl_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::ActuatorControl & ros_message =
    *(mavros_msgs::msg::ActuatorControl *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_ActuatorControl__handle;
}
