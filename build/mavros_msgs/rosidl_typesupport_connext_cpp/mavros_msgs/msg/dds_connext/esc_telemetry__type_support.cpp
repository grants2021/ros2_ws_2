...
#include "mavros_msgs/msg/esc_telemetry__rosidl_typesupport_connext_cpp.hpp"
...
bool convert_ros_message_to_dds(
  ...
  mavros_msgs::msg::dds_::ESCTelemetryItem_ &);
bool convert_dds_message_to_ros(
  const mavros_msgs::msg::dds_::ESCTelemetryItem_ &,
    ...
    for (size_t i = 0; i < size; i++) {
      if (
        !mavros_msgs::msg::typesupport_connext_cpp::convert_ros_message_to_dds(
          ...
          dds_message.esc_telemetry_[static_cast<DDS_Long>(i)]))
      {
        return false;
      }
    }
  ...
  mavros_msgs::msg::ESCTelemetry & ros_message)
{
  ...
  // member.name esc_telemetry
  {
    size_t size = dds_message.esc_telemetry_.length();
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::ESCTelemetry & ros_message =
    *(const mavros_msgs::msg::ESCTelemetry *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::ESCTelemetry_ * dds_message = mavros_msgs::msg::dds_::ESCTelemetry_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::ESCTelemetry & ros_message =
    *(mavros_msgs::msg::ESCTelemetry *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_ESCTelemetry__handle;
}
