...
#ifndef VehicleInfo_Plugin_1135824232_h
#define VehicleInfo_Plugin_1135824232_h
...
namespace mavros_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define VehicleInfo_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define VehicleInfo_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define VehicleInfo_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define VehicleInfo_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define VehicleInfo_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern VehicleInfo_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            VehicleInfo_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                VehicleInfo_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            VehicleInfo_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                VehicleInfo_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            VehicleInfo_Plugin_new(void);

            NDDSUSERDllExport extern void
            VehicleInfo_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* VehicleInfo_Plugin_1135824232_h */
