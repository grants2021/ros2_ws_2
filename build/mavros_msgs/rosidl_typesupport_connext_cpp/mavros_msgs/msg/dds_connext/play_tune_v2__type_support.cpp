...
#include "mavros_msgs/msg/play_tune_v2__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::PlayTuneV2_ & dds_message)
{
  ...
  // member.name tune
  DDS_String_free(dds_message.tune_);
  dds_message.tune_ =
    DDS_String_dup(ros_message.tune.c_str());
  ...
  mavros_msgs::msg::PlayTuneV2 & ros_message)
{
  ...
  // member.name tune
  ros_message.tune = dds_message.tune_;

  return true;
}

bool
to_cdr_stream__PlayTuneV2(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::PlayTuneV2 & ros_message =
    *(const mavros_msgs::msg::PlayTuneV2 *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::PlayTuneV2_ * dds_message = mavros_msgs::msg::dds_::PlayTuneV2_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::PlayTuneV2 & ros_message =
    *(mavros_msgs::msg::PlayTuneV2 *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_PlayTuneV2__handle;
}
