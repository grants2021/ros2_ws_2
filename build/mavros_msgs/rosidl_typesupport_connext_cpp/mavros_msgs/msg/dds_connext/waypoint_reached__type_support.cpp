...
#include "mavros_msgs/msg/waypoint_reached__rosidl_typesupport_connext_cpp.hpp"
...
DDS_TypeCode *
get_type_code__WaypointReached()
{
...
bool
to_cdr_stream__WaypointReached(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::WaypointReached & ros_message =
    *(const mavros_msgs::msg::WaypointReached *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::WaypointReached_ * dds_message = mavros_msgs::msg::dds_::WaypointReached_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::WaypointReached & ros_message =
    *(mavros_msgs::msg::WaypointReached *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_WaypointReached__handle;
}
