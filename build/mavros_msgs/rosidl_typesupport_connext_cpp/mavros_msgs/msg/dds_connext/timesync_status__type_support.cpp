...
#include "mavros_msgs/msg/timesync_status__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::TimesyncStatus_ & dds_message)
{
  ...
  dds_message.remote_timestamp_ns_ =
    ros_message.remote_timestamp_ns;

  // member.name observed_offset_ns
  dds_message.observed_offset_ns_ =
    ros_message.observed_offset_ns;

  // member.name estimated_offset_ns
  dds_message.estimated_offset_ns_ =
    ros_message.estimated_offset_ns;

  // member.name round_trip_time_ms
  dds_message.round_trip_time_ms_ =
    ros_message.round_trip_time_ms;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::TimesyncStatus & ros_message =
    *(const mavros_msgs::msg::TimesyncStatus *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::TimesyncStatus_ * dds_message = mavros_msgs::msg::dds_::TimesyncStatus_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::TimesyncStatus & ros_message =
    *(mavros_msgs::msg::TimesyncStatus *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_TimesyncStatus__handle;
}
