...
#include "mavros_msgs/msg/radio_status__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::RadioStatus_ & dds_message)
{
  ...
  dds_message.remnoise_ =
    ros_message.remnoise;

  // member.name rxerrors
  dds_message.rxerrors_ =
    ros_message.rxerrors;
  ...
  dds_message.rssi_dbm_ =
    ros_message.rssi_dbm;

  // member.name remrssi_dbm
  dds_message.remrssi_dbm_ =
    ros_message.remrssi_dbm;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::RadioStatus & ros_message =
    *(const mavros_msgs::msg::RadioStatus *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::RadioStatus_ * dds_message = mavros_msgs::msg::dds_::RadioStatus_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::RadioStatus & ros_message =
    *(mavros_msgs::msg::RadioStatus *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_RadioStatus__handle;
}
