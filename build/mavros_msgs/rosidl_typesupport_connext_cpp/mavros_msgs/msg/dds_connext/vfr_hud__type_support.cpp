...
#include "mavros_msgs/msg/vfr_hud__rosidl_typesupport_connext_cpp.hpp"
  ...
  mavros_msgs::msg::dds_::VfrHud_ & dds_message)
{
  ...
  dds_message.airspeed_ =
    ros_message.airspeed;

  // member.name groundspeed
  dds_message.groundspeed_ =
    ros_message.groundspeed;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs::msg::VfrHud & ros_message =
    *(const mavros_msgs::msg::VfrHud *)untyped_ros_message;

  // create a respective connext dds type
  mavros_msgs::msg::dds_::VfrHud_ * dds_message = mavros_msgs::msg::dds_::VfrHud_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  mavros_msgs::msg::VfrHud & ros_message =
    *(mavros_msgs::msg::VfrHud *)untyped_ros_message;
...
{
  return &mavros_msgs::msg::typesupport_connext_cpp::_VfrHud__handle;
}
