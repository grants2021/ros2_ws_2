...
static const _LogRequestEnd_Request_type_support_symbol_names_t _LogRequestEnd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, LogRequestEnd_Request)),
...
static const _LogRequestEnd_Response_type_support_symbol_names_t _LogRequestEnd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, LogRequestEnd_Response)),
...
static const _LogRequestEnd_type_support_symbol_names_t _LogRequestEnd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, LogRequestEnd)),
