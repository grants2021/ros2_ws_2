...
static const _StreamRate_Request_type_support_symbol_names_t _StreamRate_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, StreamRate_Request)),
...
static const _StreamRate_Response_type_support_symbol_names_t _StreamRate_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, StreamRate_Response)),
...
static const _StreamRate_type_support_symbol_names_t _StreamRate_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, StreamRate)),
