...
static const _FileClose_Request_type_support_symbol_names_t _FileClose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, FileClose_Request)),
...
static const _FileClose_Response_type_support_symbol_names_t _FileClose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, FileClose_Response)),
...
static const _FileClose_type_support_symbol_names_t _FileClose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, FileClose)),
