...
static const _FileOpen_Request_type_support_symbol_names_t _FileOpen_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, FileOpen_Request)),
...
static const _FileOpen_Response_type_support_symbol_names_t _FileOpen_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, FileOpen_Response)),
...
static const _FileOpen_type_support_symbol_names_t _FileOpen_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, FileOpen)),
