...
static const _WaypointClear_Request_type_support_symbol_names_t _WaypointClear_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, WaypointClear_Request)),
...
static const _WaypointClear_Response_type_support_symbol_names_t _WaypointClear_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, WaypointClear_Response)),
...
static const _WaypointClear_type_support_symbol_names_t _WaypointClear_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, mavros_msgs, srv, WaypointClear)),
