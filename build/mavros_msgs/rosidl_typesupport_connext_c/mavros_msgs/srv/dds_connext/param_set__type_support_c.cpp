...
#include "mavros_msgs/srv/param_set__rosidl_typesupport_connext_c.h"
...
static DDS_TypeCode *
_ParamSet_Request__get_type_code()
{
  return mavros_msgs::srv::dds_::ParamSet_Request_TypeSupport::get_typecode();
}

static bool
_ParamSet_Request__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const mavros_msgs__srv__ParamSet_Request * ros_message =
    static_cast<const mavros_msgs__srv__ParamSet_Request *>(untyped_ros_message);
  mavros_msgs::srv::dds_::ParamSet_Request_ * dds_message =
    static_cast<mavros_msgs::srv::dds_::ParamSet_Request_ *>(untyped_dds_message);
...
static bool
_ParamSet_Request__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const mavros_msgs::srv::dds_::ParamSet_Request_ * dds_message =
    static_cast<const mavros_msgs::srv::dds_::ParamSet_Request_ *>(untyped_dds_message);
  mavros_msgs__srv__ParamSet_Request * ros_message =
    static_cast<mavros_msgs__srv__ParamSet_Request *>(untyped_ros_message);
  // Member name: param_id
  {
...
static bool
_ParamSet_Request__to_cdr_stream(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs__srv__ParamSet_Request * ros_message =
    static_cast<const mavros_msgs__srv__ParamSet_Request *>(untyped_ros_message);
  mavros_msgs::srv::dds_::ParamSet_Request_ dds_message;
  if (!_ParamSet_Request__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  bool success = _ParamSet_Request__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _ParamSet_Request__callbacks = {
  ...
  "ParamSet_Request",  // message_name
  _ParamSet_Request__get_type_code,  // get_type_code
  _ParamSet_Request__convert_ros_to_dds,  // convert_ros_to_dds
  _ParamSet_Request__convert_dds_to_ros,  // convert_dds_to_ros
  _ParamSet_Request__to_cdr_stream,  // to_cdr_stream
  _ParamSet_Request__to_message  // to_message
};
...
static DDS_TypeCode *
_ParamSet_Response__get_type_code()
{
  return mavros_msgs::srv::dds_::ParamSet_Response_TypeSupport::get_typecode();
}

static bool
_ParamSet_Response__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const mavros_msgs__srv__ParamSet_Response * ros_message =
    static_cast<const mavros_msgs__srv__ParamSet_Response *>(untyped_ros_message);
  mavros_msgs::srv::dds_::ParamSet_Response_ * dds_message =
    static_cast<mavros_msgs::srv::dds_::ParamSet_Response_ *>(untyped_dds_message);
  // Member name: success
  {
...
static bool
_ParamSet_Response__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const mavros_msgs::srv::dds_::ParamSet_Response_ * dds_message =
    static_cast<const mavros_msgs::srv::dds_::ParamSet_Response_ *>(untyped_dds_message);
  mavros_msgs__srv__ParamSet_Response * ros_message =
    static_cast<mavros_msgs__srv__ParamSet_Response *>(untyped_ros_message);
  // Member name: success
  {
...
static bool
_ParamSet_Response__to_cdr_stream(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!untyped_ros_message) {
  ...
  const mavros_msgs__srv__ParamSet_Response * ros_message =
    static_cast<const mavros_msgs__srv__ParamSet_Response *>(untyped_ros_message);
  mavros_msgs::srv::dds_::ParamSet_Response_ dds_message;
  if (!_ParamSet_Response__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
...
static bool
_ParamSet_Response__to_message(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  bool success = _ParamSet_Response__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _ParamSet_Response__callbacks = {
  "mavros_msgs::srv",  // message_namespace
  "ParamSet_Response",  // message_name
  _ParamSet_Response__get_type_code,  // get_type_code
  _ParamSet_Response__convert_ros_to_dds,  // convert_ros_to_dds
  _ParamSet_Response__convert_dds_to_ros,  // convert_dds_to_ros
  _ParamSet_Response__to_cdr_stream,  // to_cdr_stream
  _ParamSet_Response__to_message  // to_message
};
...
static void * create_requester__ParamSet(
...
{
  return mavros_msgs::srv::typesupport_connext_cpp::create_requester__ParamSet(
    untyped_participant,
    request_topic_str,
    response_topic_str,
...
static const char * destroy_requester__ParamSet(
  void * untyped_requester,
  void (* deallocator)(void *))
{
  return mavros_msgs::srv::typesupport_connext_cpp::destroy_requester__ParamSet(
    untyped_requester, deallocator);
}

static int64_t send_request__ParamSet(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  ...
  >;
  connext::WriteSample<mavros_msgs::srv::dds_::ParamSet_Request_> request;
  const rosidl_message_type_support_t * ts =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_connext_c,
    mavros_msgs, srv,
...
static void * create_replier__ParamSet(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
  ...
  void * (*allocator)(size_t))
{
  return mavros_msgs::srv::typesupport_connext_cpp::create_replier__ParamSet(
    untyped_participant,
    request_topic_str,
    response_topic_str,
    untyped_datareader_qos,
...
static const char * destroy_replier__ParamSet(
  void * untyped_replier,
  void (* deallocator)(void *))
{
  return mavros_msgs::srv::typesupport_connext_cpp::destroy_replier__ParamSet(
    untyped_replier, deallocator);
}

static bool take_request__ParamSet(
  void * untyped_replier,
...
static bool take_response__ParamSet(
  void * untyped_requester,
  rmw_service_info_t * request_header,
...
{
  return mavros_msgs::srv::typesupport_connext_cpp::get_request_datawriter__ParamSet(
    untyped_requester);
}
...
{
  return mavros_msgs::srv::typesupport_connext_cpp::get_reply_datareader__ParamSet(
    untyped_requester);
}
...
{
  return mavros_msgs::srv::typesupport_connext_cpp::get_request_datareader__ParamSet(
    untyped_replier);
}
...
{
  return mavros_msgs::srv::typesupport_connext_cpp::get_reply_datawriter__ParamSet(
    untyped_replier);
}
...
static rosidl_service_type_support_t _ParamSet__type_support = {
  rosidl_typesupport_connext_c__identifier,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(
  ...
  ParamSet)()
{
  return &_ParamSet__type_support;
}
