...
#include "mavros_msgs/msg/vibration__rosidl_typesupport_connext_c.h"
...
#include "mavros_msgs/msg/dds_connext/Vibration_Support.h"
#include "mavros_msgs/msg/dds_connext/Vibration_Plugin.h"
...
static DDS_TypeCode *
_Vibration__get_type_code()
{
  return mavros_msgs::msg::dds_::Vibration_TypeSupport::get_typecode();
}

static bool
_Vibration__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const mavros_msgs__msg__Vibration * ros_message =
    static_cast<const mavros_msgs__msg__Vibration *>(untyped_ros_message);
  mavros_msgs::msg::dds_::Vibration_ * dds_message =
    static_cast<mavros_msgs::msg::dds_::Vibration_ *>(untyped_dds_message);
  // Member name: header
  {
  ...
  // Member name: vibration
  {
    ...
    if (!geometry_msgs__msg__Vector3__callbacks->convert_ros_to_dds(
        &ros_message->vibration, &dds_message->vibration_))
    {
      return false;
    }
  }
  // Member name: clipping
  {
    ...
    for (DDS_Long i = 0; i < static_cast<DDS_Long>(size); ++i) {
      auto & ros_i = ros_message->clipping[i];
      dds_message->clipping_[i] = ros_i;
    }
  }
  return true;
}
...
static bool
_Vibration__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const mavros_msgs::msg::dds_::Vibration_ * dds_message =
    static_cast<const mavros_msgs::msg::dds_::Vibration_ *>(untyped_dds_message);
  mavros_msgs__msg__Vibration * ros_message =
    static_cast<mavros_msgs__msg__Vibration *>(untyped_ros_message);
  // Member name: header
  {
  ...
  // Member name: vibration
  {
    ...
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(ts->data);
    callbacks->convert_dds_to_ros(&dds_message->vibration_, &ros_message->vibration);
  }
  // Member name: clipping
  {
    DDS_Long size = 3;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs__msg__Vibration * ros_message =
    static_cast<const mavros_msgs__msg__Vibration *>(untyped_ros_message);
  mavros_msgs::msg::dds_::Vibration_ dds_message;
  if (!_Vibration__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  bool success = _Vibration__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _Vibration__callbacks = {
  ...
  "Vibration",  // message_name
  _Vibration__get_type_code,  // get_type_code
  _Vibration__convert_ros_to_dds,  // convert_ros_to_dds
  _Vibration__convert_dds_to_ros,  // convert_dds_to_ros
  _Vibration__to_cdr_stream,  // to_cdr_stream
  _Vibration__to_message  // to_message
};
