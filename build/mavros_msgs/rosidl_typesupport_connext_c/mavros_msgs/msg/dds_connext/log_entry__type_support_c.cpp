...
#include "mavros_msgs/msg/log_entry__rosidl_typesupport_connext_c.h"
...
#include "mavros_msgs/msg/dds_connext/LogEntry_Support.h"
#include "mavros_msgs/msg/dds_connext/LogEntry_Plugin.h"
...
static DDS_TypeCode *
_LogEntry__get_type_code()
{
  return mavros_msgs::msg::dds_::LogEntry_TypeSupport::get_typecode();
}

static bool
_LogEntry__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const mavros_msgs__msg__LogEntry * ros_message =
    static_cast<const mavros_msgs__msg__LogEntry *>(untyped_ros_message);
  mavros_msgs::msg::dds_::LogEntry_ * dds_message =
    static_cast<mavros_msgs::msg::dds_::LogEntry_ *>(untyped_dds_message);
  // Member name: header
  {
  ...
  {
    dds_message->num_logs_ = ros_message->num_logs;
  }
  // Member name: last_log_num
  {
    dds_message->last_log_num_ = ros_message->last_log_num;
  }
  // Member name: time_utc
  {
    ...
    if (!builtin_interfaces__msg__Time__callbacks->convert_ros_to_dds(
        &ros_message->time_utc, &dds_message->time_utc_))
    {
      return false;
    }
  }
...
static bool
_LogEntry__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const mavros_msgs::msg::dds_::LogEntry_ * dds_message =
    static_cast<const mavros_msgs::msg::dds_::LogEntry_ *>(untyped_dds_message);
  mavros_msgs__msg__LogEntry * ros_message =
    static_cast<mavros_msgs__msg__LogEntry *>(untyped_ros_message);
  // Member name: header
  {
  ...
  // Member name: num_logs
  {
    ros_message->num_logs = dds_message->num_logs_;
  }
  // Member name: last_log_num
  {
    ros_message->last_log_num = dds_message->last_log_num_;
  }
  // Member name: time_utc
  {
    const rosidl_message_type_support_t * ts =
    ...
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(ts->data);
    callbacks->convert_dds_to_ros(&dds_message->time_utc_, &ros_message->time_utc);
  }
  // Member name: size
  {
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs__msg__LogEntry * ros_message =
    static_cast<const mavros_msgs__msg__LogEntry *>(untyped_ros_message);
  mavros_msgs::msg::dds_::LogEntry_ dds_message;
  if (!_LogEntry__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  bool success = _LogEntry__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _LogEntry__callbacks = {
  ...
  "LogEntry",  // message_name
  _LogEntry__get_type_code,  // get_type_code
  _LogEntry__convert_ros_to_dds,  // convert_ros_to_dds
  _LogEntry__convert_dds_to_ros,  // convert_dds_to_ros
  _LogEntry__to_cdr_stream,  // to_cdr_stream
  _LogEntry__to_message  // to_message
};
