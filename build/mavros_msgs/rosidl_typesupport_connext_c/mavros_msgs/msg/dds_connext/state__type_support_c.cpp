...
#include "mavros_msgs/msg/state__rosidl_typesupport_connext_c.h"
...
#include "mavros_msgs/msg/dds_connext/State_Support.h"
#include "mavros_msgs/msg/dds_connext/State_Plugin.h"
...
static DDS_TypeCode *
_State__get_type_code()
{
  return mavros_msgs::msg::dds_::State_TypeSupport::get_typecode();
}

static bool
_State__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const mavros_msgs__msg__State * ros_message =
    static_cast<const mavros_msgs__msg__State *>(untyped_ros_message);
  mavros_msgs::msg::dds_::State_ * dds_message =
    static_cast<mavros_msgs::msg::dds_::State_ *>(untyped_dds_message);
  // Member name: header
  {
  ...
  {
    dds_message->connected_ = ros_message->connected;
  }
  // Member name: armed
  {
    dds_message->armed_ = ros_message->armed;
  }
  // Member name: guided
  {
    dds_message->guided_ = ros_message->guided;
  }
  // Member name: manual_input
  {
    dds_message->manual_input_ = ros_message->manual_input;
  }
  // Member name: mode
  {
...
static bool
_State__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const mavros_msgs::msg::dds_::State_ * dds_message =
    static_cast<const mavros_msgs::msg::dds_::State_ *>(untyped_dds_message);
  mavros_msgs__msg__State * ros_message =
    static_cast<mavros_msgs__msg__State *>(untyped_ros_message);
  // Member name: header
  {
  ...
  // Member name: connected
  {
    ros_message->connected = dds_message->connected_ == static_cast<DDS_Boolean>(true);
  }
  // Member name: armed
  {
    ros_message->armed = dds_message->armed_ == static_cast<DDS_Boolean>(true);
  }
  // Member name: guided
  {
    ros_message->guided = dds_message->guided_ == static_cast<DDS_Boolean>(true);
  }
  // Member name: manual_input
  {
    ros_message->manual_input = dds_message->manual_input_ == static_cast<DDS_Boolean>(true);
  }
  // Member name: mode
  {
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const mavros_msgs__msg__State * ros_message =
    static_cast<const mavros_msgs__msg__State *>(untyped_ros_message);
  mavros_msgs::msg::dds_::State_ dds_message;
  if (!_State__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  bool success = _State__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _State__callbacks = {
  ...
  "State",  // message_name
  _State__get_type_code,  // get_type_code
  _State__convert_ros_to_dds,  // convert_ros_to_dds
  _State__convert_dds_to_ros,  // convert_dds_to_ros
  _State__to_cdr_stream,  // to_cdr_stream
  _State__to_message  // to_message
};
