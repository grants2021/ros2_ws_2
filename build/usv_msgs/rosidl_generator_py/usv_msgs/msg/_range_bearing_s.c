...
bool usv_msgs__msg__range_bearing__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("usv_msgs.msg._range_bearing.RangeBearing", full_classname_dest, 40) == 0);
  }
  usv_msgs__msg__RangeBearing * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RangeBearing */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("usv_msgs.msg._range_bearing");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RangeBearing");
