...
: ${AMENT_CURRENT_PREFIX:="/home/grant/ros2_ws/install/vrx_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vrx_gazebo/environment/library_path.sh"
