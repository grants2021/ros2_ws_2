...
static const _Task_type_support_symbol_names_t _Task_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, vrx_gazebo, msg, Task)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vrx_gazebo, msg, Task)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vrx_gazebo, msg, Task)),
  }
};
...
{
  return &::vrx_gazebo::msg::rosidl_typesupport_cpp::Task_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vrx_gazebo, msg, Task)() {
  return get_message_type_support_handle<vrx_gazebo::msg::Task>();
}
