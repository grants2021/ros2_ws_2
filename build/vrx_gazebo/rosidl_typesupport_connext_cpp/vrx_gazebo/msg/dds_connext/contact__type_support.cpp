...
#include "vrx_gazebo/msg/contact__rosidl_typesupport_connext_cpp.hpp"
  ...
  vrx_gazebo::msg::dds_::Contact_ & dds_message)
{
  ...
  DDS_String_free(dds_message.collision1_);
  dds_message.collision1_ =
    DDS_String_dup(ros_message.collision1.c_str());

  // member.name collision2
  DDS_String_free(dds_message.collision2_);
  dds_message.collision2_ =
    DDS_String_dup(ros_message.collision2.c_str());
  ...
  vrx_gazebo::msg::Contact & ros_message)
{
  ...
  // member.name collision1
  ros_message.collision1 = dds_message.collision1_;

  // member.name collision2
  ros_message.collision2 = dds_message.collision2_;
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const vrx_gazebo::msg::Contact & ros_message =
    *(const vrx_gazebo::msg::Contact *)untyped_ros_message;

  // create a respective connext dds type
  vrx_gazebo::msg::dds_::Contact_ * dds_message = vrx_gazebo::msg::dds_::Contact_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  vrx_gazebo::msg::Contact & ros_message =
    *(vrx_gazebo::msg::Contact *)untyped_ros_message;
...
{
  return &vrx_gazebo::msg::typesupport_connext_cpp::_Contact__handle;
}
