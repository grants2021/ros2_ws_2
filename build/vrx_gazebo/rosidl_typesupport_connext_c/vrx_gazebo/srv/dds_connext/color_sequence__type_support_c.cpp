...
#include "vrx_gazebo/srv/color_sequence__rosidl_typesupport_connext_c.h"
...
static DDS_TypeCode *
_ColorSequence_Request__get_type_code()
{
  return vrx_gazebo::srv::dds_::ColorSequence_Request_TypeSupport::get_typecode();
}

static bool
_ColorSequence_Request__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const vrx_gazebo__srv__ColorSequence_Request * ros_message =
    static_cast<const vrx_gazebo__srv__ColorSequence_Request *>(untyped_ros_message);
  vrx_gazebo::srv::dds_::ColorSequence_Request_ * dds_message =
    static_cast<vrx_gazebo::srv::dds_::ColorSequence_Request_ *>(untyped_dds_message);
  // Member name: color1
  {
    ...
    dds_message->color1_ = DDS_String_dup(str->data);
  }
  // Member name: color2
  {
    ...
    dds_message->color2_ = DDS_String_dup(str->data);
  }
  // Member name: color3
  {
    ...
    dds_message->color3_ = DDS_String_dup(str->data);
  }
  return true;
}

static bool
_ColorSequence_Request__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const vrx_gazebo::srv::dds_::ColorSequence_Request_ * dds_message =
    static_cast<const vrx_gazebo::srv::dds_::ColorSequence_Request_ *>(untyped_dds_message);
  vrx_gazebo__srv__ColorSequence_Request * ros_message =
    static_cast<vrx_gazebo__srv__ColorSequence_Request *>(untyped_ros_message);
  // Member name: color1
  {
...
static bool
_ColorSequence_Request__to_cdr_stream(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const vrx_gazebo__srv__ColorSequence_Request * ros_message =
    static_cast<const vrx_gazebo__srv__ColorSequence_Request *>(untyped_ros_message);
  vrx_gazebo::srv::dds_::ColorSequence_Request_ dds_message;
  if (!_ColorSequence_Request__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
...
static bool
_ColorSequence_Request__to_message(
  ...
  void * untyped_ros_message)
{
  ...
  bool success = _ColorSequence_Request__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _ColorSequence_Request__callbacks = {
  "vrx_gazebo::srv",  // message_namespace
  "ColorSequence_Request",  // message_name
  _ColorSequence_Request__get_type_code,  // get_type_code
  _ColorSequence_Request__convert_ros_to_dds,  // convert_ros_to_dds
  _ColorSequence_Request__convert_dds_to_ros,  // convert_dds_to_ros
  _ColorSequence_Request__to_cdr_stream,  // to_cdr_stream
  _ColorSequence_Request__to_message  // to_message
};
...
static DDS_TypeCode *
_ColorSequence_Response__get_type_code()
{
  return vrx_gazebo::srv::dds_::ColorSequence_Response_TypeSupport::get_typecode();
}

static bool
_ColorSequence_Response__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const vrx_gazebo__srv__ColorSequence_Response * ros_message =
    static_cast<const vrx_gazebo__srv__ColorSequence_Response *>(untyped_ros_message);
  vrx_gazebo::srv::dds_::ColorSequence_Response_ * dds_message =
    static_cast<vrx_gazebo::srv::dds_::ColorSequence_Response_ *>(untyped_dds_message);
  // Member name: success
  {
...
static bool
_ColorSequence_Response__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const vrx_gazebo::srv::dds_::ColorSequence_Response_ * dds_message =
    static_cast<const vrx_gazebo::srv::dds_::ColorSequence_Response_ *>(untyped_dds_message);
  vrx_gazebo__srv__ColorSequence_Response * ros_message =
    static_cast<vrx_gazebo__srv__ColorSequence_Response *>(untyped_ros_message);
  // Member name: success
  {
...
static bool
_ColorSequence_Response__to_cdr_stream(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!untyped_ros_message) {
  ...
  const vrx_gazebo__srv__ColorSequence_Response * ros_message =
    static_cast<const vrx_gazebo__srv__ColorSequence_Response *>(untyped_ros_message);
  vrx_gazebo::srv::dds_::ColorSequence_Response_ dds_message;
  if (!_ColorSequence_Response__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
...
static bool
_ColorSequence_Response__to_message(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  bool success = _ColorSequence_Response__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _ColorSequence_Response__callbacks = {
  "vrx_gazebo::srv",  // message_namespace
  "ColorSequence_Response",  // message_name
  _ColorSequence_Response__get_type_code,  // get_type_code
  _ColorSequence_Response__convert_ros_to_dds,  // convert_ros_to_dds
  _ColorSequence_Response__convert_dds_to_ros,  // convert_dds_to_ros
  _ColorSequence_Response__to_cdr_stream,  // to_cdr_stream
  _ColorSequence_Response__to_message  // to_message
};
...
static void * create_requester__ColorSequence(
...
{
  return vrx_gazebo::srv::typesupport_connext_cpp::create_requester__ColorSequence(
    untyped_participant,
    request_topic_str,
    response_topic_str,
...
static const char * destroy_requester__ColorSequence(
  void * untyped_requester,
  void (* deallocator)(void *))
{
  return vrx_gazebo::srv::typesupport_connext_cpp::destroy_requester__ColorSequence(
    untyped_requester, deallocator);
}

static int64_t send_request__ColorSequence(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  ...
  >;
  connext::WriteSample<vrx_gazebo::srv::dds_::ColorSequence_Request_> request;
...
static void * create_replier__ColorSequence(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
  ...
  void * (*allocator)(size_t))
{
  return vrx_gazebo::srv::typesupport_connext_cpp::create_replier__ColorSequence(
    untyped_participant,
    request_topic_str,
    response_topic_str,
    untyped_datareader_qos,
...
static const char * destroy_replier__ColorSequence(
  void * untyped_replier,
  void (* deallocator)(void *))
{
  return vrx_gazebo::srv::typesupport_connext_cpp::destroy_replier__ColorSequence(
    untyped_replier, deallocator);
}

static bool take_request__ColorSequence(
  void * untyped_replier,
...
static bool take_response__ColorSequence(
  void * untyped_requester,
  rmw_service_info_t * request_header,
...
{
  return vrx_gazebo::srv::typesupport_connext_cpp::get_request_datawriter__ColorSequence(
    untyped_requester);
}
...
{
  return vrx_gazebo::srv::typesupport_connext_cpp::get_reply_datareader__ColorSequence(
    untyped_requester);
}
...
{
  return vrx_gazebo::srv::typesupport_connext_cpp::get_request_datareader__ColorSequence(
    untyped_replier);
}
...
{
  return vrx_gazebo::srv::typesupport_connext_cpp::get_reply_datawriter__ColorSequence(
    untyped_replier);
}

static service_type_support_callbacks_t _ColorSequence__callbacks = {
  "vrx_gazebo::srv",  // service_namespace
  "ColorSequence",
...
static rosidl_service_type_support_t _ColorSequence__type_support = {
  rosidl_typesupport_connext_c__identifier,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(
  ...
  ColorSequence)()
{
  return &_ColorSequence__type_support;
}
