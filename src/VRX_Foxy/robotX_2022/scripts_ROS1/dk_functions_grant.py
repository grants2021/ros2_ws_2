...
class Drone: 
    def __init__(self, vehicle, input_matrix):
        global alt_reached, marker_heights, movementCoeff
            ...
            try:
                if ids is not None:
                    if len(marker_heights)>1:
                        ...
                        for i in range(len(self.land_id_to_find)-1,0,-1):
                    ...
                    if land_id_to_find in ids:
                        ...
                        x_sum = 0 
                        print(ids[k])
                        x_sum = corners[0][k][0][0] + corners[0][k][1][0] + corners[0][k][2][0] + corners[0][k][3][0]
                        y_sum = corners[0][k][0][1] + corners[0][k][1][1] + corners[0][k][2][1] + corners[0][k][3][1]
