...
def generate_launch_description():
    ...
    wamv_models_path = os.path.join(wamv_pkg_share, 'models')
    ...
    start_robot_state_publisher_cmd = Node(
        ...
        parameters=[{'arucos_enabled':True},{'robot_description': ParameterValue(Command(['xacro ', wamv_model]), value_type=str)}])
    # Specify the actions
